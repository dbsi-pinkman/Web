...
namespace Dal
{
    ...
    public class MSSQLHelper
    {
        ...
        public MSSQLHelper()
        {
            ...
            //<connectionStrings>
            //    <add name="connStr" connectionString="server=(local)\XUGUO;uid=sa;pwd=200505;database=工夹具系统;Connect Timeout=10;" />	
            //</connectionStrings>
            string connStr = @"server=(local)\XUGUO;uid=sa;pwd=200505;database=工夹具系统;Connect Timeout=10;";
